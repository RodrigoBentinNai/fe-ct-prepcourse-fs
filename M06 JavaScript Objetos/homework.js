...
function invocarMetodo(objeto, metodo) {
   ...
   //if (objeto && objeto[metodo] && typeof objeto[metodo] === 'function') {
   //   objeto[metodo]()
   //}
}
...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
   ...
   //var resultado = return objetoMisterioso.numeroMisterioso * 5
   //return resultado;
...
function tieneEmail(objetoUsuario) {
   ...
   //if ("email" in objetoUsuario && objetoUsuario.email) {
   //   return true;
   //} else {
   //   return false;
   //}
...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   //const totalLikes = objetoUsuario.posts.reduce((suma, post) => suma + (post.likes || 0), 0);
...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   //   const montoDescuento = precio * porcentajeDeDescuento;
